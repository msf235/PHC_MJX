...
py phc_mjx/run.py env="env_im" env.motion_file=sample_data/amass_isaac_standing_upright_slim.pkl \
  exp_name=im_obsv2_standing headless=False test=True epoch=-1
