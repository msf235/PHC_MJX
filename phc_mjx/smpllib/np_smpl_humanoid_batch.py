...
from phc_mjx.utils.torch_ext import dict_to_torch

sys.path.append(os.getcwd())

from phc_mjx.utils.torch_utils import *
from phc_mjx.utils.np_transform_utils import *
from scipy.spatial.transform import Rotation as sRot
import joblib
from mujoco_py import load_model_from_path
from phc_mjx.smpllib.smpl_joint_names import SMPLConverter, smpl_to_qpose, smpl_to_qpose_torch, SMPL_BONE_ORDER_NAMES
from phc_mjx.smpllib.smpl_parser import SMPL_EE_NAMES
from phc_mjx.utils.tools import get_expert, get_expert_master
...
if __name__ == "__main__":
    import mujoco_py
    from phc_mjx.smpllib.smpl_robot import Robot
    from phc_mjx.smpllib.torch_smpl_humanoid import Humanoid
    from phc_mjx.utils.config_utils.copycat_config import Config
    from phc_mjx.data_loaders.dataset_amass_single import DatasetAMASSSingle
    from phc_mjx.utils.torch_ext import dict_to_torch
    from phc_mjx.smpllib.smpl_mujoco import smpl_to_qpose_torch, smplh_to_smpl
    torch.manual_seed(0)
