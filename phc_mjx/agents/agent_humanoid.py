...
from phc_mjx.agents.agent_ppo import AgentPPO
...
from phc_mjx.envs import HumanoidIm  # TODO: add others as appropriate
...
class AgentHumanoid(AgentPPO):
    ...
    def save_checkpoint(self):
        print(
            f"==============================Saving checkpoint model: Epoch {self.epoch}=============================="
        )
        torch.save(
            self.get_full_state_weights(),
            f"{self.cfg.output_dir}/Humanoid_{self.epoch:08d}.pth",
        )

    def save_curr(self):
        print(
            f"==============================Saving current model: Epoch {self.epoch}=============================="
        )
