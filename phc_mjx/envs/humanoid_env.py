...
from phc_mjx.envs.base_env import BaseEnv
import phc_mjx.envs.controllers as ctrls
    ...
    def setup_humanoid_properties(self):
        ...
        if self.robot is not None:
            ...
            if self.humanoid_type in ["smpl", "smplh", "smplx"]:
                ...
                self.q_names = self.mj_joint_names[
                    2:
                ]  # TODO: this assumes 2d dynamics, need to update
            else:
                raise NotImplementedError(f"humanoid_type: {self.humanoid_type}")
